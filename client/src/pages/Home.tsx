...
import Profile from "/attached_assets/Profile.jpg"
import Architecture from "/attached_assets/Architecture.png"
import { 
  Pagination,
  PaginationContent,
  PaginationItem,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">DocumentIQ</h1>
